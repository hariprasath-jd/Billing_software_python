...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1 = Button(root)
        self.button1.place(relx=0.366, rely=0.785, width=356, height=43)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#D2463E")
        self.button1.configure(cursor="hand2")
        ...
        self.button1.configure(command=self.back)

    def back(self):
        sure = messagebox.askyesno("Back", "Are you sure you want to go Back?")
        if sure == True:
            root.withdraw()
        ...
        if self.state == 1:
            ...
            if(cust_name.get()==""):
                ...
                if strr.find('Total')==-1:
                    ...
                    cust_new_bill.set(random_bill_number(5))
